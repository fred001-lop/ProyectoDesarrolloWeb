...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
     <h1 class="h3 mb-0 text-gray-800">Panel de Registro</h1>
            ...
            <div class="card">
                <form action="" autocomplete="off" method="post" class="card-body p-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Ingrese su Nombre" name="proveedor" id="nombre" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="contacto">RTU:</label>
                    ...
                    <a href="lista_proveedor.php" class="btn btn-warning">Regresar</a>
